...
exports.obterPostagens = function(idPostagem){
    console.log(idPostagem);
    return new Promise(function(resolve,reject){
        var listaPostagem;
        
        Postagem.aggregate([
            { $match : {_id: ObjectId(idPostagem)}},
            { $lookup:
            {
                from: 'exercicios',
                localField: 'exercicio_id',
...
exports.obterPostagensUsuarioWeb= function(clienteId){
